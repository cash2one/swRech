...
* auther zzd
*/
class tyxlj3dlogincheck extends \request_class
{
/*
* cmd and cmd arg`s count must modity
*/
const CMD_NUM 	= '/tyou_xlj_loginstate.xl';
const ARG_COUNT	= 0;
...
public	static	function handler($request,$response)
{
	...
	$postData	= array
	(
		'appid' => SECRET_TIANYOUXLJ3D_APPID,
		'userid'=> $uid,
		'usertoken' => $token,
	);

	\async_http::do_http(SECRET_TIANYOUXLJ3D_CHECK_IP,SECRET_TIANYOUXLJ3D_CHECK_URI,$postData,array(__CLASS__, 'resp_check_login'),array($response,$uid,$session));
	return;
}
